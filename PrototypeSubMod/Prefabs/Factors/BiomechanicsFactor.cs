...
public static class BiomechanicsFactor
{
    ...
    public static void Register()
    {
        ...
        prefab.SetRecipe(ROTACompatManager.GetRelevantRecipe("BiomechanicsFactor.json"))
            .WithCraftingTime(3f);
    ...
    private static IEnumerator GetPrefab(IOut<GameObject> prefabOut)
    {
        ...
        instance.name = "BiomechanicsFactor";
        instance.AddComponent<BiomechanicsFactorLogic>();
